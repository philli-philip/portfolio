...
export const OrderStream = PubSub<SetOrder>();
export const FilterByStatusStream = PubSub<FilterByStatus>();

export type SetOrder = { SetOrder: { orderBy: string } };
export type FilterByStatus = { FilterByStatus: { filter: string } };
