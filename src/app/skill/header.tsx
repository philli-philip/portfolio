...
export default function Header() {
  return (
    <Section>
      ...
      <p className="max-w-[50ch] pt-4 text-sm text-black/60">
        Largely based on Figmas Design ladder. My addition is the guidance what
        level you are based on the skills you have.
      </p>
      <ol className="fley-row flex gap-x-8 pb-12 pt-4 text-sm text-black/60">
